...
class CATTLE_IDENTIFICATION(PipelineMixin):
    ...
    def reset_duplicate_tracking_identification(self,tracking_ids):
        for tracking_id in tracking_ids:
            ...
            #batch_default = {'TOTAL_COUNT':0 , 'HOLDING' : 'Identifying','LOCATION' : self.BATCH_CLASSIFICATION_TRACKER[track_index]['LOCATION'] , }
            default = {'GT': ['Reidentifying'], 'COUNT':[0], 'IS_STABLE':False,  'HAS_MISSED_FRAME' : False, 'REIDENTIFY_MISSED_COUNT' : self.REIDENTIFY_MISSED_COUNT, 'RECHECK_COUNT':0 }
    ...
    def GetBatchPredictedId(self, tracking_id, is_small, save_dir, missed_frame_count, location, w, h):
        ...
        if not is_small:
            ...
            if self.CLASSIFICATION_TRACKER[track_index]['HAS_MISSED_FRAME'] == True or self.CLASSIFICATION_TRACKER[track_index]['RECHECK_COUNT'] > 0:  # keep searching if small
                if self.CLASSIFICATION_TRACKER[track_index]['REIDENTIFY_MISSED_COUNT']:
                ...
                FORCE_MISSED_IDENTIFICATION = self.CLASSIFICATION_TRACKER[track_index]['REIDENTIFY_MISSED_COUNT'] < 1 or self.CLASSIFICATION_TRACKER[track_index]['REIDENTIFY_MISSED_COUNT'] < 1
        ...
        if total_predictions > self.total_predictions  and not self.CLASSIFICATION_TRACKER[track_index][
            'HAS_MISSED_FRAME'] and not FORCE_MISSED_IDENTIFICATION:
        #and not IS_STABLE:  # and if not stable
            ...
            elif total_predictions % 500 == 0:  # NOT RESETTING
                FORCE_IDENTIFICATION = True
                IS_RECHECK_PERIOD = True
                #self.BATCH_CLASSIFICATION_TRACKER[track_index]['TOTAL_COUNT'] = 0
    ...
    def CoreProcess(self,boxes,masks_np,h,w,frame,cam_counter):
        ...
        for box in boxes:
            ...
            if True :#HOKKAIDO_ROI(x1,y1,x2,y2,h,w):  #only cow class
                ...
                #predicted_id
                predicted_id,tracking_id, IS_RECHECK_PERIOD = self.GetBatchPredictedId(int(prev_id[0]),isSmall,self.save_dir,missed_frame_count,prev_id[1],w,h)
    ...
    def begin_process(self,cam_datas,isCam,camera_number=None,lane = "Left"):
        ...
        for idx in range(number_of_videos): 
            ...
            project = f'E:/Output/runs/{self.FARMNAME}_identification/KNP_Merge_and_Batch_identification/19 Oct Report Recheck Count 2025/reuse tetris_Sumiyoshi-44/{model_name}/testris_{channel}'
    ...
    predictor_path = Path("identification_models_KNP") / "KNP_CONVNEXT_Nighttime_01"
...
if __name__ == '__main__':
    ...
    inputs = [
            ...
            # ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch001_Camera 001_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch002_Camera 002_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch003_Camera 003_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch004_Camera 004_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch005_Camera 005_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch006_Camera 006_E2\\2025-04-14\\0023"]
            ],
            [
                # ["E:\\E2\\Ch002_Camera 002_E2\\2025-09-20\\1521"],
                 ["G:\\Nyi Zaw Aung\\815_CowDataChecking\\KNP\\Standard_Format\\ALL_Channel_One_Day\\Ch007_Camera 007_E2\\2025-04-14\\0023"]
            ]
            # [
                 #
